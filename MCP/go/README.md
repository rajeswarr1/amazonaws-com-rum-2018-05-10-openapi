# CloudWatch RUM MCP Server

This MCP (Model Content Protocol) server provides access to CloudWatch RUM API functionality through HTTP, HTTPS, and STDIO transport modes.
